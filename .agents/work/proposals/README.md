...
| [PROP-IMPORT-RESOLUTION](PROP-IMPORT-RESOLUTION-import-resolution-and-multifile-compilation-unit-v0.md) / [P2](PROP-IMPORT-RESOLUTION-P2-implementation-planning-v0.md) | authored + implementation planning conditional | `import` = compile-time name resolution only; N `.ig` files form one logical compilation universe and one `.igapp`; P2 selects compiler-driver pre-pass + merged logical universe; P3 is held pending OOF-M1/M2 diagnostic namespace cleanup; import grants no capability/profile/package/runtime authority; package/stdlib/visibility/implementation deferred |
