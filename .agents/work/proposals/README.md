...
| [PROP-IMPORT-RESOLUTION](PROP-IMPORT-RESOLUTION-import-resolution-and-multifile-compilation-unit-v0.md) / [P2](PROP-IMPORT-RESOLUTION-P2-implementation-planning-v0.md) / [P2A](PROP-IMPORT-RESOLUTION-P2A-diagnostic-namespace-decision-v0.md) / [P4](PROP-IMPORT-RESOLUTION-P4-ruby-canon-parity-decision-v0.md) | authored + planning + diagnostic namespace accepted + Ruby parity ready | `import` = compile-time name resolution only; N `.ig` files form one logical compilation universe and one `.igapp`; P2 selects compiler-driver pre-pass + merged logical universe; P2A reserves `OOF-IMP*`; Rust-lab P3 proved implementation 83/83 as evidence; P4 decides Ruby canon parity is ready for bounded P5 via orchestrator pre-pass, source_units evidence, final diagnostics, entrypoint coexistence, and no CLI/public API/package/visibility/stdlib/runtime/VM/capability authority |
